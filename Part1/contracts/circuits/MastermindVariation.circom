...
6 digits
4 holes
Uses numbers instead of colors. 
The codemaker may optionally give, as an extra clue, the sum of the digits.
*/
...
template MastermindVariation() {
    ...
    //sum of the inputs provided to the code breaker
    signal input pubSum;
    ...
    //check if the public sum is equal to the actual sum
